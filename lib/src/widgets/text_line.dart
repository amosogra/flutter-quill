...
class _TextLineState extends State<TextLine> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.line.hasEmbed && widget.line.childCount == 1) {
      ...
      return EmbedProxy(widget.embedBuilder(context, widget.controller, embed, widget.readOnly));
    }
  ...
  InlineSpan _getTextSpanForWholeLine(BuildContext context) {
    ...
    for (final child in widget.line.children) {
      if (child is Embed) {
        ...
        final embed = WidgetSpan(child: EmbedProxy(widget.embedBuilder(context, widget.controller, child, widget.readOnly)));
...
class EditableTextLine extends RenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    ...
    return RenderEditableTextLine(
        line, textDirection, textSelection, enableInteractiveSelection, hasFocus, devicePixelRatio, _getPadding(), color, cursorCont, defaultStyles.inlineCode!);
  }
